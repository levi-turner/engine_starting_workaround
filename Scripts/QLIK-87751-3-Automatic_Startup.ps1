...
$server4 = 'qlikserver3.domain.local'
...
foreach ($service in $qliksenseservice ) {
    Get-Service -Name $qliksenseservice.Name -ComputerName $server1 | Set-Service -StartupType Automatic  
}
# Repeat on server2
$qliksenseservice = Get-Service -Name Qlik* -ComputerName $server2
foreach ($service in $qliksenseservice ) {
    Get-Service -Name $qliksenseservice.Name -ComputerName $server2 | Set-Service -StartupType Automatic  
}
# Repeat on server3
$qliksenseservice = Get-Service -Name Qlik* -ComputerName $server3
foreach ($service in $qliksenseservice ) {
    Get-Service -Name $qliksenseservice.Name -ComputerName $server3 | Set-Service -StartupType Automatic  
}
# Repeat on server4
$qliksenseservice = Get-Service -Name Qlik* -ComputerName $server4
foreach ($service in $qliksenseservice ) {
    Get-Service -Name $qliksenseservice.Name -ComputerName $server4 | Set-Service -StartupType Automatic  
}